...
2. Import the required Python libraries such as Pandas, Scikit-learn, Matplotlib, and Seaborn.
3. Load the Iris dataset using load_iris()
4. Create a Pandas DataFrame using the Iris feature names.
5. Add the target/class column to the DataFrame.
6. Separate the dataset into:
x  y

7. Split the dataset into training and testing data using
testing data.
8. Create an
9. Train the model using the training data with
10. Predict the classes of the test data using predict()
11. Calculate the accuracy using accuracy_score()
12. Generate the confusion matrix using confusion_matrix()
13. Display the confusion matrix as a heatmap using Seaborn.
14. Label the axes with the actual Iris class names.
...
## Output:
<img width="847" height="845" alt="image" src="https://github.com/user-attachments/assets/eac801be-11ae-4a6b-96cb-ba08c52d6b8e" />

<img width="812" height="857" alt="image" src="https://github.com/user-attachments/assets/bde7aac5-43a8-43dd-b5e9-7da0b23aa8cc" />

<img width="685" height="833" alt="image" src="https://github.com/user-attachments/assets/840a5976-4c0b-4f90-9113-1b586a52e3a1" />
